...
function install_packages
{
  ...
  yum install -y boost1.78-devel fftw-devel openblas-devel wget
...
set -euo pipefail
set -x
curl -O -L https://files.pythonhosted.org/packages/8d/59/b4572118e098ac8e46e399a1dd0f2d85403ce8bbaad9ec79373ed6badaf9/PySocks-1.7.1-py3-none-any.whl
pip install pysocks --no-index --find-links ./
install_packages
